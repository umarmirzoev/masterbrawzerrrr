...
const FAQ_GROUPS = [
  ...
  },
  {
    ...
    icon: Users,
    items: [
      { q: "Кто такие мастера Master.TJ?", a: "Это независимые специалисты, прошедшие проверку документов и опыта перед подключением к платформе. Их работу оценивают реальные клиенты." },
