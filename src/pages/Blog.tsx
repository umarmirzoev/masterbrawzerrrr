...
const POSTS: Post[] = [
  {
    ...
    content: [
      ...
      "Просите называть цену до начала работ, а не по факту. На Master.TJ мастера обязаны согласовать стоимость заранее.",
  ...
  },
  {
    ...
    content: [
      ...
      "Сравнивайте цены минимум у двух-трёх мастеров перед началом крупных работ — в каталоге Master.TJ это можно сделать без лишних звонков.",
  ...
  },
  {
    ...
    content: [
      ...
      "Не передавайте предоплату наличными до начала работ — на Master.TJ оплата происходит после выполнения заказа.",
